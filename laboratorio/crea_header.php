...
class Crea_header {
    ...
    function __construct($base){
        ...
        $this->archivo_header("header", $this->menu($enlace));        
    }

    public function conexion_menu($base){
        $host = 'localhost';
        $user = 'root';
        $password = '';
        $database = $base;
    ...
    public function archivo_header($tabla, $contenido) {
